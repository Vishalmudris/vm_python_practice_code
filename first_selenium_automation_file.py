...
driver.find_element(By.NAME, 'fld_cpassword').send_keys('ItsPassword@1234')
driver.find_element(By.NAME, 'phone').send_keys('123456789')
driver.find_element(By.NAME, 'address').send_keys('The Address Details')
driver.find_element(By.XPATH, "//input[@name='add_type' and @value='office']").click()
driver.find_element(By.NAME, 'fld_username').send_keys('testusernamekirti')
...
driver.find_element(By.NAME, 'zip').send_keys('411001')
